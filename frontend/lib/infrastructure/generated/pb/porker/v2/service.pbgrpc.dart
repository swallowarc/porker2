...
class Porker2ServiceClient extends $grpc.Client {
  ...
  Porker2ServiceClient(super.channel, {super.options, super.interceptors});
  ...
  $grpc.ResponseFuture<$0.VerifyUserResponse> verifyUser(
    $0.VerifyUserRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseStream<$0.JoinRoomResponse> joinRoom(
  ...
  $grpc.ResponseFuture<$0.ShowVotesResponse> showVotes(
    $0.ShowVotesRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$showVotes, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResetVotesResponse> resetVotes(
    $0.ResetVotesRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$resetVotes, request, options: options);
  }

  $grpc.ResponseFuture<$0.KickUserResponse> kickUser(
    $0.KickUserRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.ToggleObserverModeResponse> toggleObserverMode(
    $0.ToggleObserverModeRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$verifyUser =
      $grpc.ClientMethod<$0.VerifyUserRequest, $0.VerifyUserResponse>(
          '/porker.v2.Porker2Service/VerifyUser',
          ($0.VerifyUserRequest value) => value.writeToBuffer(),
          $0.VerifyUserResponse.fromBuffer);
  ...
  static final _$showVotes =
      $grpc.ClientMethod<$0.ShowVotesRequest, $0.ShowVotesResponse>(
          '/porker.v2.Porker2Service/ShowVotes',
          ($0.ShowVotesRequest value) => value.writeToBuffer(),
          $0.ShowVotesResponse.fromBuffer);
  static final _$resetVotes =
      $grpc.ClientMethod<$0.ResetVotesRequest, $0.ResetVotesResponse>(
          '/porker.v2.Porker2Service/ResetVotes',
          ($0.ResetVotesRequest value) => value.writeToBuffer(),
          $0.ResetVotesResponse.fromBuffer);
  static final _$kickUser =
      $grpc.ClientMethod<$0.KickUserRequest, $0.KickUserResponse>(
          '/porker.v2.Porker2Service/KickUser',
          ($0.KickUserRequest value) => value.writeToBuffer(),
          $0.KickUserResponse.fromBuffer);
  ...
  static final _$toggleObserverMode = $grpc.ClientMethod<
          $0.ToggleObserverModeRequest, $0.ToggleObserverModeResponse>(
      '/porker.v2.Porker2Service/ToggleObserverMode',
      ($0.ToggleObserverModeRequest value) => value.writeToBuffer(),
      $0.ToggleObserverModeResponse.fromBuffer);
}
...
abstract class Porker2ServiceBase extends $grpc.Service {
  ...
  Porker2ServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ToggleObserverModeRequest,
            $0.ToggleObserverModeResponse>(
        'ToggleObserverMode',
        toggleObserverMode_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ToggleObserverModeRequest.fromBuffer(value),
  ...
  $async.Future<$0.VerifyUserResponse> verifyUser_Pre($grpc.ServiceCall $call,
      $async.Future<$0.VerifyUserRequest> $request) async {
    return verifyUser($call, await $request);
  }

  $async.Future<$0.VerifyUserResponse> verifyUser(
      $grpc.ServiceCall call, $0.VerifyUserRequest request);
  ...
  $async.Future<$0.ShowVotesResponse> showVotes_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ShowVotesRequest> $request) async {
    return showVotes($call, await $request);
  }

  $async.Future<$0.ShowVotesResponse> showVotes(
      $grpc.ServiceCall call, $0.ShowVotesRequest request);

  $async.Future<$0.ResetVotesResponse> resetVotes_Pre($grpc.ServiceCall $call,
      $async.Future<$0.ResetVotesRequest> $request) async {
    return resetVotes($call, await $request);
  }

  $async.Future<$0.ResetVotesResponse> resetVotes(
      $grpc.ServiceCall call, $0.ResetVotesRequest request);

  $async.Future<$0.KickUserResponse> kickUser_Pre($grpc.ServiceCall $call,
      $async.Future<$0.KickUserRequest> $request) async {
    return kickUser($call, await $request);
  }

  $async.Future<$0.KickUserResponse> kickUser(
      $grpc.ServiceCall call, $0.KickUserRequest request);
  ...
  $async.Future<$0.ToggleObserverModeResponse> toggleObserverMode_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ToggleObserverModeRequest> $request) async {
    return toggleObserverMode($call, await $request);
  }

  $async.Future<$0.ToggleObserverModeResponse> toggleObserverMode(
      $grpc.ServiceCall call, $0.ToggleObserverModeRequest request);
}
